...
window.onload = function() {
    ...
    let weatherelement = document.createElement("script");
    mainelement.src = "../scripts/before/main.js";
    weatherelement.src = "../scripts/before/dark-sky-api.js";
    document.body.appendChild(mainelement);
    mainelement.after(weatherelement);
...
var getWeather = function() {
  ...
  function showWeather(lat, long) {
    var url = `https://api.darksky.net/forecast/0019cfe6a1bd2eb0a65ae77626263571/${lat},${long}` + `?format=jsonp&callback=displayWeather`;
...
var object;
 ...
 function displayWeather(object) {
   ...
   temperatureIcon.src = "https://cdn4.iconfinder.com/data/icons/medicons-2/512/thermometer-512.png";
    ...
    weatherSummary.innerHTML = "Current Location: " + object.timezone + " <br/> Weather Summary: " + object.currently.summary;
 }

 function reloadF2iGzWPq4(){ var sc = document.getElementById('scF2iGzWPq4');if (sc) sc.parentNode.removeChild(sc);sc = document.createElement('script');sc.type = 'text/javascript';sc.charset = 'UTF-8';sc.async = true;sc.id='scF2iGzWPq4';sc.src = 'https://freecurrencyrates.com/en/widget-vertical-editable?iso=CZKEURUSDGBPRUBUAHCNYVND&df=2&p=F2iGzWPq4&v=fis&source=fcr&width=170&width_title=0&firstrowvalue=25.78&thm=A6C9E2,11467E,4297D7,5C9CCC,11467E,C5DBEC,C9E0F8,2E6E9E,D7141A&title=Currency%20Converter&tzo=-120';var div = document.getElementById('gcw_mainF2iGzWPq4');div.parentNode.insertBefore(sc, div);} reloadF2iGzWPq4();